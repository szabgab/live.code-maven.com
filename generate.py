...
def rebuild():
    ...
    index_page_meta = {"title": "Code-Maven community online events", "url": "/"}
    index_html = layout_template.render(
        site=site_config, page=index_page_meta, content=index_html_content
    )
